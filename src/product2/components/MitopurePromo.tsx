...
/* Copied verbatim from science/components/MitopurePromo.tsx, the promo band at
 * the foot of the science page. Markup, classes and copy are unchanged; only
 * the CSS is re-scoped, in product/stylesheets/science-banner.css. */
