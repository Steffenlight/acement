...
import Outlined_five_point_star from './icons/Outlined_five_point_star.tsx'
import Outlined_five_point_star1 from './icons/Outlined_five_point_star1.tsx'
import NestedImage from './NestedImage.tsx'
...
// Component
                        ...
                        <div className={"chakra-aspect-ratio css-mdthky"}>
                            <div className={"css-3qzm71"}>
                                <div className={"css-l8fc8q"}>
                                    ...
                                    <NestedImage className="css-1z0hfml" imgId={primaryImgId} />
                                    <NestedImage className="css-l5goe2" imgId={secondaryImgId} />
                                </div>
                            </div>
                        </div>
        ...
        function getProductCardData(id: string): ProductCardData {
            ...
            return {
                ...
                star: <Outlined_five_point_star1 />
            };
        }
