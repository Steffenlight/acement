...
// Component
        ...
        function getCreatorVideoData(id: string): CreatorVideoData {
            ...
            const data: Record<string, CreatorVideoData> = {
                "0": {
                    poster: "images/071fe6cf-73e9-4597-a575-c415d29b1722.png",
                    title: "Chloé Zakhour"
                },
                "1": {
                ...
                "3": {
                    poster: "images/7e78d8cc-0086-4771-94da-89b03be073d8.png",
                    title: "Britt | Travel &amp; UGC Creator"
                },
                "4": {
                    poster: "images/0e53f428-23ae-4b06-94a8-d4b5b5c1207c.png",
                    title: "Tiffanie | Health &amp; Wellness &amp; UGC"
                },
                "5": {
                    poster: "images/4917f1d2-bcd9-46b7-8aa4-f55b916cc00f.png",
                    title: "Bonnie Leathers"
                },
                "6": {
                    poster: "images/44107e68-6ecc-47c4-8f69-5ce7ca063efe.png",
